...
import static com.CIMthetics.jvulkan.VulkanCore.VulkanFunctions.vkGetPhysicalDeviceFormatProperties;
...
import com.CIMthetics.jvulkan.VulkanCore.Structures.CreateInfos.VkPipelineDepthStencilStateCreateInfo;
...
/**
 * This is the vulkan tutorial on depth buffering.
 * 
 * @author Douglas Kaip
 *
 */
...
//        int totalSizeInBytes = (positionSize + colorSize + textureCoordinatesSize) * 4 /* for 4 vertices */;
        ...
        int totalSizeInBytes = getSizeOfVertexInBytes() * vertices.length;
        ...
        FloatBuffer floatBuffer = FloatBuffer.allocate(vertices.length * 8);
    ...
    private void createGraphicsPipeline()
    {
        ...
        try
        {
            vertexShaderModuleReferenceHandle =
                    loadShader(shaderPath + "VulkanTutorial7Shader.vert.spv", vulkanLogicalDevice);
            
            fragmentShaderModuleReferenceHandle =
                    loadShader(shaderPath + "VulkanTutorial7Shader.frag.spv", vulkanLogicalDevice);
